...
const WhereWasSpend1 = document.getElementById("control1T");
const WhereWasSpend2 = document.getElementById("control2T");
...
addButton.onclick = () => {
  ...
  if (WhereWasSpend1.value) {
    ...
    wrongType(WhereWasSpend1);
  }
}

const wrongType = (elem) => {
  elem.classList.add("animate__shakeX", "redBoxSh");
}
